...
/**
 * Low-level fetch wrapper for the Stripe API.
 * Uses native fetch which works reliably on Vercel (Node 24),
 * unlike the Stripe SDK whose http client fails in this environment.
 */
...
// ---- Public API (drop-in replacements for Stripe SDK calls) ----
...
/**
 * Verify a Stripe webhook signature. Uses SubtleCrypto (available in Node 18+).
 */
