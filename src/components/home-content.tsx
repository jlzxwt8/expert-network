      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 px-6 pt-12 pb-16 md:pt-16 md:pb-24">
        ...
        <div className="relative z-10">
          ...
          <p className="text-lg text-slate-300 mb-8 max-w-md">
            Join our community of 1,000+ verified professionals. Get advisory
            sessions on AI, fintech, and business from experts who have been
            there.
          </p>
            ...
            {isTelegram ? (
              ...
              <>
                <Button
                  ...
                  className="bg-indigo-500 hover:bg-indigo-600 text-white shadow-lg shadow-indigo-500/25 font-semibold"
                >
                  <Link href="/auth/signin?role=expert">
                    I&apos;m an Expert
                  </Link>
                </Button>
                <Button
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm">
                  Every expert is vetted and verified. Connect with
                  professionals who have real industry experience.
                </p>
              </div>
            </div>
          </div>
